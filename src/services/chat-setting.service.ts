...
export class ChatSettingService implements IChatSettingProvider {
  ...
  async update(data: { memoryContextThreshold?: number; maxOutputTokens?: number | null; searchLinkCount?: number; searchSummaryConcurrency?: number; chunkCharRange?: string; userProfile?: string | null }): Promise<ChatSettingInfo> {
